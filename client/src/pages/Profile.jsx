...
//         (<span className='text-red-700'>Error Image Upload(Image uploade must be less then 2mb)</span>) : filePerc > 0 && filePerc < 100 ? (<span className='text-slate-700'>{`Uploading ${filePerc}%`}</span>) : filePerc === 100 ? (
